    ...
    <SafeAreaView style={MyStyleSheet.container}>
      ...
      <ScrollView contentContainerStyle={{ paddingHorizontal: 30, paddingBottom: 40, paddingTop: 20 }}>
        ...
        <View style={{ marginTop: 10 }}>
          ...
          <TextInput style={MyStyleSheet.inputBox}   value={user?.fname || ""} editable={false} />

          <Text style={MyStyleSheet.inputLabel}>Last Name</Text>

          <TextInput  style={MyStyleSheet.inputBox}  value={user?.lname || ""}  editable={false} />

          <Text style={MyStyleSheet.inputLabel}>Email</Text>

          <TextInput style={MyStyleSheet.inputBox}  value={user?.email || ""}  editable={false} />

          <Text style={MyStyleSheet.inputLabel}>Contact Number</Text>
          <TextInput  style={MyStyleSheet.inputBox}  value={user?.contact || ""}  editable={false} />

          <Text style={MyStyleSheet.inputLabel}>Password</Text>

          <TextInput  style={MyStyleSheet.inputBox}  value={user?.password || ""}  secureTextEntry={true}  editable={false}/>
        </View>
        ...
        <View style={{ marginTop: 20 }}>
          ...
          <TouchableOpacity style={MyStyleSheet.secondaryOutlineBtn} onPress={() => setLogoutVisible(true)}>
        ...
        <View style={MyStyleSheet.modalOverlay}>
          ...
          <View style={MyStyleSheet.logoutModalContainer}>
            ...
            <View style={MyStyleSheet.logoutActionRow}>
              ...
              <TouchableOpacity  style={MyStyleSheet.yesBtn} onPress={() => { setLogoutVisible(false); updateUser(null); opx.navigate('login');  }} >
