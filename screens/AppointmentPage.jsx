...
export default function AppointmentPage() {
  ...
  const appointmentData = [
    ...
    { id: '2', date: 'Saturday, 07 February', time: '9:00 AM', service: 'Service Name', pet: 'Pet Name', status: 'Scheduled', type: 'Upcoming' },
      ...
      <View style={MyStyleSheet.apptCardContent}>
        <View style={{ flex: 1 }}>
          ...
          <View style={MyStyleSheet.apptServiceRow}>
            {/* SVG Replacement for Stethoscope 🩺 */}
          ...
          <View style={[
            ...
            { backgroundColor: item.status === 'Pending Confirmation' ? '#FFE8D1' : item.status === 'Scheduled' ? '#D1E3FF' : '#D1FFD7' }
          ]}>
    ...
    <SafeAreaView style={MyStyleSheet.container}>
      <View style={MyStyleSheet.apptHeaderContainer}>
        <View style={MyStyleSheet.apptHeader}>
          <View>
            <Text style={MyStyleSheet.apptHiUser}>Hi, User!</Text>
          </View>
          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
            <View style={MyStyleSheet.apptUserCircle} />
            {/* SVG Replacement for Notification Bell 🔔 */}
