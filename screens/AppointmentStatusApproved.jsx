  ...
  return (
    <SafeAreaView style={MyStyleSheet.container}>
      ...
      <ScrollView contentContainerStyle={{ paddingHorizontal: 25, paddingBottom: 40, paddingTop: 20 }}>
        ...
        <TouchableOpacity style={MyStyleSheet.ghostCancelBtn}  onPress={() => setCancelModalVisible(true)}>
      ...
      <Modal visible={successModalVisible} transparent animationType="fade">
        ...
        <View style={MyStyleSheet.modalOverlay}>
          ...
          <View style={MyStyleSheet.policyBox}>
            ...
            <TouchableOpacity style={MyStyleSheet.modalUnderstandBtn} onPress={() => { setSuccessModalVisible(false); navigation.navigate('cancelled'); }}
            >
